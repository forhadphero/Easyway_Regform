...
$unread = "SELECT COUNT(*) as total FROM messages";
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="brand-title" src="/Easyway_Regform/assets/images/SoftDevs1.jpeg" width="50" alt="">
            </a>
							...
							<li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
                                            <?php foreach($mesg_res as $mesg){ ?>
											<li>
												<a href="../message/view.php?id=<?=$mesg['id']?>">
                                                <div class="timeline-panel">
													<div class="media-body">
														<h6 class="mb-1"><strong><?=$mesg['name']?></strong> Send you Message</h6>
														<small class="d-block"><?=date('d-m-y, h:i:s a', strtotime($mesg['created_at']))?></small>
													</div>
												</div> 
                                                </a>
											</li>
                                    ...
                                    <a class="all-notification" href="javascript:void(0)">See all Message <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
